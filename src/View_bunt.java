...
class View_bunt implements Observer {
    ...
    View_bunt() {
        ...
        panel_source_second.setBackground(new Color(50, 120, 200));
        ...
        panel_target_first.setBackground(new Color(50, 145, 150));
        ...
        panel_target_second.setBackground(new Color(50, 120, 200));
        ...
        panel_options.setBackground(new Color(150, 50, 50));
        ...
        source_count.setForeground(new Color(255, 255, 255));
        ...
        panel_filename.setBackground(new Color(200, 180, 10));
        ...
        panel_result.setBackground(new Color(200, 150, 200));
        ...
        panel_log.setBackground(new Color(60, 0, 160));
        ...
        textArea_log.setBackground(new Color(220, 220, 220));
        scrollPane_log.setViewportView(textArea_log);

        JPanel panel_table = new JPanel();
        panel_table.setBackground(new Color(10, 160, 190));
        ...
        panel_presets.setBackground(new Color(150, 25, 200));
        ...
        btn_paula.setBackground(new Color(200, 230, 250));
        panel_presets.add(btn_paula);

        btn_galeria = new JButton("Galeria Kaufhof");
        btn_galeria.setBackground(new Color(200, 230, 250));
        panel_presets.add(btn_galeria);

        // Trennzeichen

        JPanel panel_trennzeichen = new JPanel();
        panel_trennzeichen.setBackground(new Color(160, 245, 245));
        ...
        panel_kennung.setBackground(new Color(160, 45, 245));
    ...
    public void addController(Controller controller){
        ...
        btn_galeria.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                controller.setPreset("galeria");
            }
        });
    ...
    public String getKennung_source(){
        return this.textArea_1.getText();
    }
    public String getKennung_target(){
